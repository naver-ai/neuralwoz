...
parser.add_argument('-seed','--seed', help='random seed', required=False, type=int, default=42)
parser.add_argument('-dataset_dir', '--dataset_dir', help='dataset_dir', required=False, type=str, default=None)
parser.add_argument('-output_path', '--output_path', help='output_path', required=False, type=str, default=None)
parser.add_argument('-train_data','--train_data', help='train_data for each experiments', required=False, type=str, default=None)
parser.add_argument('-target_domain','--target_domain', help='except domain to perform revised zero-shot scheme', required=False, type=str, default=None)
